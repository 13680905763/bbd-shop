...
export const GoogleIcon: React.FC<IconSvgProps> = ({
  ...
  >
    <path
      d="M21.8055 10.0415H21V10H12V14H17.6515C16.827 16.3285 14.6115 18 12 18C8.6865 18 6 15.3135 6 12C6 8.6865 8.6865 6 12 6C13.5295 6 14.905 6.574 15.963 7.5095L18.912 4.5605C17.0995 2.8715 14.704 1.818 12 1.818C6.3765 1.818 1.818 6.3765 1.818 12C1.818 17.6235 6.3765 22.182 12 22.182C17.6235 22.182 22.182 17.6235 22.182 12C22.182 11.3785 22.083 10.7335 21.8055 10.0415Z"
      fill="#FFC107"
    />
    <path
      d="M3.15295 7.3455L6.4385 9.755C7.3275 7.554 9.4805 6 12 6C13.5295 6 14.905 6.574 15.963 7.5095L18.912 4.5605C17.0995 2.8715 14.704 1.818 12 1.818C8.1135 1.818 4.6745 4.058 3.15295 7.3455Z"
      fill="#FF3D00"
    />
    <path
      d="M12 22.1818C14.704 22.1818 17.0995 21.1283 18.912 19.4393L15.657 16.9438C14.6528 17.6405 13.3865 18.0007 12 18C9.3885 18 7.173 16.3285 6.3485 14H0.753V18.3208C2.2745 21.6083 5.7135 23.8483 9.6035 23.8483C10.4303 23.8483 11.2368 23.7228 12 22.1818Z"
      fill="#4CAF50"
    />
    <path
      d="M22.1818 12C22.1818 11.3785 22.083 10.7335 21.8055 10.0415H21V10H12V14H17.6515C17.2571 15.1082 16.5467 16.0766 15.657 16.9438L18.912 19.4393C19.9613 18.4711 20.8144 17.2766 21.4035 15.9605C21.916 14.734 22.1818 13.393 22.1818 12Z"
      fill="#1976D2"
    />
  </svg>
);
